...
5. **Web Server**: Provides HTTP interface on Ethernet for monitoring and logs
6. **Traffic Routing**: All Ethernet traffic flows through WiFi NAT, enabling access to the WiFi network and target IP
